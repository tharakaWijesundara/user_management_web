...
class Home extends Component {
    ...
    getData = () => {
        if (this.state.loggedInStatus) {
            //get wrokers
            axios.get("http://localhost:3000/api/users/workers")
                .then(response => {
                    this.setState({
            ...
            axios.get(`http://localhost:3000/api/users/without/${this.state.loggerDetails.idNum}`)
                .then(response => {
            ...
            //get styles
            axios.get("http://localhost:3000/api/users/getStyles")
                .then(response => {
            ...
            //get styles names
            axios.get("http://localhost:3000/api/users/getStylesNames")
                .then(response => {
    ...
    render() {
        ...
        } else if (!isLoadedHeads || !isLoadedWorkers || !isLoadedStyles || !isLoadedStylesNames) {
            return (
                <div>......Loading.....</div>
            )
        }
