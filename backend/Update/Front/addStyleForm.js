...
class stylesWindow extends Component {
    constructor(props) {
        super(props)
        this.state = {
            name: "", stich_count: "", error_margin: "", prop3: "", prop4: "", prop5: ""
        }
    }
    ...
    handleSubmit = () => {
        var { name, stich_count, error_margin, prop3, prop4, prop5 } = this.state;
        let style = Object.assign({}, { name, stich_count, error_margin, prop3, prop4, prop5 });
            ...
            <div className="styleForm">
                ...
                <Form >
                    ...
                    <Form.Row>
                        ...
                        <Form.Group as={Col} controlId="prop3">
                            <Form.Label>prop3</Form.Label>
                            <Form.Control
                                placeholder="prop3"
                                onChange={(item) => this.changeWorker("prop3", item)}
